...
import { getAllSendsByProblemId } from "../ServiceLayer/problems/GetAllSendsByProblemId.js";
...
problemsRouter.get("/problems/getAllSendsByProblemId", auth(), getAllSendsByProblemId());
