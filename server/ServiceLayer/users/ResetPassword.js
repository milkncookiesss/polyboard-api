  ...
  return async (req, res, next) => {
    ...
    try {
      ...
      const mailData = {
        ...
        <br>Please use this link to enter back into the Polyboard App and continue the process to reset your password: <a hfref="http://localhost:8000/api/deeplink?url=fingerclimbing://forgetpassword/">here</a></br>`,
        html: `
        <b>Hello this is an automated email to reset your password.</b>
        <br>Please use this link to enter back into the Polyboard App and continue the process to reset your password: <a href="http://localhost:8000/api/deeplink?url=fingerclimbing://forgetpassword/">here</a></br>`,
      };
